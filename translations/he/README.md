...
![AI גנרטיבי למתחילים](../../translated_images/he/repo-thumbnailv2.06f4a48036fde647.webp)
...
[![סוגיות ב-GitHub](https://img.shields.io/github/issues/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/issues/?WT.mc_id=academic-105485-koreyst)
...
[![בקשות משיכה - ברוכים הבאים](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
**אם תרצו לתרום בשפות נוספות שנמצאות ברשימה [כאן](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
הקורס הזה כולל שיעורים שמכסים את היסודות של בניית סוכני AI. כל שיעור מכסה נושא משלו, אז התחילו איפה שתרצו!

יש תמיכה בריבוי שפות לקורס זה. לכו ל-[השפות הזמינות כאן](../..).

אם זו הפעם הראשונה שלכם בבנייה עם מודלים גנרטיביים, בדקו את הקורס [AI גנרטיבי למתחילים](https://aka.ms/genai-beginners), הכולל 21 שיעורים על בנייה עם GenAI.

אל תשכחו [לתת כוכב (🌟) למאגר זה](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ו-[לעשות Fork למאגר](https://github.com/microsoft/ai-agents-for-beginners/fork) כדי להריץ את הקוד.

### פגשו לומדים נוספים, קבלו מענה לשאלותיכם

אם נתקעתם או יש לכם שאלות על בניית סוכני AI, הצטרפו לערוץ ה-Discord הייעודי שלנו ב-[Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### מה תצטרכו

כל שיעור בקורס כולל דוגמאות קוד, שניתן למצוא בתיקיית code_samples. אתם יכולים [לעשות Fork למאגר](https://github.com/microsoft/ai-agents-for-beginners/fork) כדי ליצור עותק משלכם.

דוגמת הקוד בתרגילים הללו משתמשת ב-Azure AI Foundry וקטלוגי מודלים של GitHub לאינטראקציה עם מודלי שפה:
...
הקורס משתמש גם במסגרת ושירותי סוכני AI הבאים של מיקרוסופט:

- [מסגרת סוכני מיקרוסופט (MAF) - חדש!](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [שירות סוכני Azure AI](https://aka.ms/ai-agents-beginners/ai-agent-service)
- [Semantic Kernel](https://aka.ms/ai-agents-beginners/semantic-kernel)
- [AutoGen](https://aka.ms/ai-agents/autogen)


למידע נוסף על הפעלת הקוד של הקורס, עברו ל-[הגדרת הקורס](./00-course-setup/README.md).

## 🙏 רוצים לעזור?

יש לכם הצעות או מצאתם טעויות באיות או בקוד? [צורו נושא](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) או [פתחו בקשת משיכה](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- דוגמאות קוד בפייתון התומכות ב-Azure AI Foundry ובמודלים מ-Github (חינמיים)
...
|---------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| מבוא לסוכני AI ולמקרי שימוש בסוכנים       | [קישור](./01-intro-to-ai-agents/README.md)          | [סרטון](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [קישור](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| שימוש בפרוטוקולים אייגנטיים (MCP, A2A ו-NLWeb) | [קישור](./11-agentic-protocols/README.md)           | [וידאו](https://youtu.be/X-Dh9R3Opn8)                                 | [קישור](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| ניהול זיכרון אייגנטי                      | [קישור](./13-agent-memory/README.md)     |      [וידאו](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| חקר מסגרת הסוכן של מיקרוסופט                         | [קישור](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| בניית סוכני שימוש במחשב (CUA)           | בקרוב                            |                                                            |                                                                                        |
| פריסת סוכנים סקלאביליים                    | בקרוב                            |                                                            |                                                                                        |
...
### סדרת Copilot
[![Copilot לתכנות משולב בינה מלאכותית](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
תודה ל-[Shivam Goyal](https://www.linkedin.com/in/shivam2003/) על תרומה של דוגמאות קוד חשובות המדגימות Agentic RAG.

## תרומה

פרויקט זה מקבל בברכה תרומות והצעות. רוב התרומות מחייבות הסכמה ל
הסכם רישיון תורם (CLA) שבו אתה מאשר שיש לך את הזכות, וכי אתה אכן מעניק לנו
את הזכויות להשתמש בתרומתך. לפרטים, בקר ב- <https://cla.opensource.microsoft.com>.

בעת הגשת בקשת משיכה, רובוט CLA יקבע אוטומטית האם עליך לספק
CLA ויעטר את הבקשה בהתאם (למשל, בדיקת סטטוס, תגובה). פשוט עקוב אחר ההוראות שהרובוט
מספק. תצטרך לעשות זאת רק פעם אחת בכל המאגרי קוד המשתמשים ב-CLA שלנו.

פרויקט זה אימץ את [קוד ההתנהגות של מיקרוסופט לקוד פתוח](https://opensource.microsoft.com/codeofconduct/).
למידע נוסף ראה את [שאלות נפוצות על קוד ההתנהגות](https://opensource.microsoft.com/codeofconduct/faq/) או צור קשר ב[opencode@microsoft.com](mailto:opencode@microsoft.com) לכל שאלה או הערה נוספת.

## סימני מסחר

ייתכן והפרויקט מכיל סימני מסחר או לוגואים של פרויקטים, מוצרים או שירותים. השימוש המורשה בסימני המסחר של מיקרוסופט
נתון לתנאי ולהנחיות
[הנחיות סימני המסחר והמותג של מיקרוסופט](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
שימוש בסימני מסחר או לוגואים של מיקרוסופט בגרסאות מותאמות של פרויקט זה אסור לגרום לבלבול או לרמז על חסות מיקרוסופט.
כל שימוש בסימני מסחר או לוגואים של צד שלישי כפוף למדיניות של צדדים אלו.
...
אם יש לך משוב או דיווחי שגיאות בעת הפיתוח בקר ב:
...
**כתב ויתור**:  
מסמך זה תורגם באמצעות שירות תרגום מבוסס בינה מלאכותית [Co-op Translator](https://github.com/Azure/co-op-translator). למרות שאנו שואפים לדיוק, יש לקחת בחשבון שתרגומים אוטומטיים עלולים להכיל שגיאות או לאי דיוקים. המסמך המקורי בשפת המקור שלו הוא המקור הסמכותי. למידע קריטי מומלץ להיעזר בתרגום של אדם מקצועי. אנו לא נושאים באחריות לכל אי הבנה או פרשנות שגויה הנובעת משימוש בתרגום זה.
